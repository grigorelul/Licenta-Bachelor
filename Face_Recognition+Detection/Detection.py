...
# Verifică versiunea OpenCV
assert cv.__version__.startswith("4.9"), "Please install latest opencv-python to try this demo: python3 -m pip install --upgrade opencv-python"
